...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-brand-cardbg border-t border-gray-200 pb-6">
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center py-2 px-4 min-w-[80px] min-h-[56px] transition-colors ${
                isActive ? "text-brand-red" : "text-gray-800 hover:text-brand-text"
              }`}
            >
