...
const SEED_BOOKINGS = [
  // === OUTBOUND: US → Beijing ===
  {
    ...
    details: { flight_number: "DL2475", departure_airport: "TPA", arrival_airport: "JFK" },
  ...
  },
  {
    ...
    details: { flight_number: "MS986", departure_airport: "JFK", arrival_airport: "CAI" },
  ...
  },
  {
    ...
    provider: "EgyptAir", confirmation_code: "A5WIT3",
    travelers: ["Tonya Clark", "Mike Clark"],
    details: { flight_number: "MS955", departure_airport: "CAI", arrival_airport: "PEK" },
    ...D("12hGicLHetLVw0Sx-l37-0JM7Poc9eowY"),
  },
  // David's separate EgyptAir booking (Flight Network, $3,598.79)
  {
    ...
    details: { flight_number: "MS986", departure_airport: "JFK", arrival_airport: "CAI", cabin: "Business", booking_source: "Flight Network" },
  ...
  },
  {
    ...
    provider: "EgyptAir", confirmation_code: "1114-237-039",
    travelers: ["David Ramos"],
    details: { flight_number: "MS955", departure_airport: "CAI", arrival_airport: "PEK", cabin: "Business", booking_source: "Flight Network" },
    ...D("1mNDiGtOCqhstWgoTjfcgkSkizMtFSk31"),
  },
  ...
  // === Amanda's outbound ===
  {
    ...
    details: { departure_airport: "STR", arrival_airport: "LHR" },
  },
  {
    ...
    provider: "Air Canada", confirmation_code: "CMVPZX",
    travelers: ["Amanda Ford"],
    details: { departure_airport: "LHR", arrival_airport: "CAI" },
  },
  {
    ...
    travelers: ["Amanda Ford"],
    details: { flight_number: "CNG655", departure_airport: "CAI", arrival_airport: "PEK" },
  },
  ...
  // === Beijing Oct 7–8 lodging ===
  {
    ...
    details: { city: "Beijing", room: "King Hilton Guestroom", guests: 2, booking_source: "Chase Travel Trip 1016467277" },
  ...
  // === Oct 8 Beijing → Bangkok → Koh Samui ===
  {
    ...
    details: { flight_number: "HU429", departure_airport: "PEK", arrival_airport: "BKK" },
  ...
  },
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark", "David Ramos"],
    details: { flight_number: "PG165", departure_airport: "BKK", arrival_airport: "USM" },
  ...
  },
  {
    ...
    travelers: ["Amanda Ford"],
    details: { flight_number: "PG165", departure_airport: "BKK", arrival_airport: "USM", note: "Combined booking with Oct 11 USM→CNX" },
  ...
  // === Oct 11 USM → CNX ===
  {
    ...
    provider: "Bangkok Airways", confirmation_code: "DL2BJG",
    travelers: ["Mike Clark", "Tonya Clark", "David Ramos"],
    details: { flight_number: "PG241", departure_airport: "USM", arrival_airport: "CNX" },
  ...
  },
  {
    ...
    provider: "Bangkok Airways", confirmation_code: "DYJW53",
    travelers: ["Amanda Ford"],
    details: { flight_number: "PG241", departure_airport: "USM", arrival_airport: "CNX", note: "Combined booking with Oct 8 BKK→USM" },
    ...D("1eXcYTBAN1dlgyGSKIDznxhOlFVDkaBBP"),
  },
  ...
  },
  {
    ...
    details: { city: "Chiang Mai", room: "Chai Lai River view", check_in: "14:00", check_out: "12:00" },
  ...
  // === Oct 13 CNX → BKK → SZX ===
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark", "David Ramos", "Amanda Ford"],
    details: { departure_airport: "CNX", arrival_airport: "BKK", booking_source: "Flight Network" },
  ...
  },
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark"],
    details: { flight_number: "CZ8324", departure_airport: "BKK", arrival_airport: "SZX" },
  ...
  // === Shenzhen Oct 13–16 ===
  {
    ...
    travelers: ["David Ramos"],
    details: { city: "Shenzhen", room: "2 King Beds, City View Glory Tower" },
    payment_method: "Cash",
  ...
  },
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark"],
    details: { city: "Shenzhen", room: "1 King, City View Main Tower" },
  ...
  // === Oct 16 SZX → TSN ===
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark"],
    details: { flight_number: "CZ8491", aircraft: "A320neo", cabin: "Economy", departure_airport: "SZX", arrival_airport: "TSN", booking_source: "Chase Travel Trip 1016464870" },
  ...
  },
  {
    ...
    travelers: ["David Ramos", "Amanda Ford"],
    details: { flight_number: "CZ8491", aircraft: "A320neo", cabin: "Economy", departure_airport: "SZX", arrival_airport: "TSN", booking_source: "Chase Travel Trip 1016457572" },
  ...
  // === Tianjin Oct 16–18 ===
  {
    ...
    travelers: ["Tonya Clark", "Mike Clark"],
    details: { city: "Tianjin", room: "Deluxe King", guests: 2, booking_source: "Amex Travel", hilton_honors: "2039501537" },
  ...
  // === Chongqing Oct 20–22 (David only) ===
  {
    ...
    travelers: ["David Ramos"],
    details: { city: "Chongqing", room: "Executive Suite" },
  ...
  // Amanda: HKG → ZRH → STR (Oct 22–23)
  {
    ...
    travelers: ["Amanda Ford"],
    details: { flight_number: "LX1164", cabin: "Business Flex", departure_airport: "HKG", arrival_airport: "ZRH" },
  ...
  },
  {
    ...
    alt_codes: { e_ticket: "724-2347588933" },
    travelers: ["Amanda Ford"],
    details: { flight_number: "LX139", cabin: "Business Flex", departure_airport: "ZRH", arrival_airport: "STR" },
    notes: "Times approximate — confirm from PDF.",
    ...D("1BK0oUsvOF1hAb3uzHNtSA-6A4Iv6GxLX"),
  },
  // David: HKG → DOH → DFW (Oct 22–23) on 7NGTZ7
  {
    ...
    travelers: ["David Ramos"],
    details: { flight_number: "QR815", departure_airport: "HKG", arrival_airport: "DOH", seat: "18G" },
  ...
  },
  {
    ...
    provider: "Qatar Airways", confirmation_code: "7NGTZ7",
    travelers: ["David Ramos"],
    details: { flight_number: "QR731", departure_airport: "DOH", arrival_airport: "DFW", seat: "4B" },
    ...D("13P9kyLVBakN_up_DBoynKgxeyaSdIHS0"),
  },
  // Mike: HKG → DOH → DFW (Oct 23–24) on 7MWYZ9
  {
    ...
    details: { flight_number: "QR815", departure_airport: "HKG", arrival_airport: "DOH", seat: "18D", pax_on_booking: 1 },
  ...
  },
  {
    ...
    provider: "Qatar Airways", confirmation_code: "7MWYZ9",
    travelers: ["Mike Clark"],
    details: { flight_number: "QR731", departure_airport: "DOH", arrival_airport: "DFW", pax_on_booking: 1 },
    ...D("1J2XGLfH5-VO0lTcLHpAVgerkC5y2nYmG"),
  },
  // Tonya: Qatar HKG→DOH→DFW — pending
  {
    ...
    travelers: ["Tonya Clark"],
    details: { flight_number: "QR815", departure_airport: "HKG", arrival_airport: "DOH" },
  ...
  },
  {
    ...
    provider: "Qatar Airways", confirmation_code: null,
    travelers: ["Tonya Clark"],
    details: { flight_number: "QR731", departure_airport: "DOH", arrival_airport: "DFW" },
  ...
  // Final leg DFW→TPA — pending
  {
    ...
    details: { flight_number: "AA2512", departure_airport: "DFW", arrival_airport: "TPA" },
