...
const SEED_BOOKINGS = [
  ...
  // === Beijing Oct 7–8 lodging ===
  {
    ...
    details: { city: "Beijing", room: "King Hilton Guestroom", guests: 2, booking_source: "Chase Travel Trip 1016467277", timezone: "China Time" },
  ...
  },
  {
    ...
    details: { city: "Beijing", timezone: "China Time" },
  ...
  },
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark", "David Ramos", "Amanda Ford"],
    details: { city: "Bangkok", timezone: "ICT" },
  ...
  },
  {
    ...
    details: { city: "Chiang Mai", room: "Chai Lai River view", check_in: "14:00", check_out: "12:00", timezone: "ICT" },
  ...
  // === Shenzhen Oct 13–16 ===
  {
    ...
    travelers: ["David Ramos"],
    details: { city: "Shenzhen", room: "2 King Beds, City View Glory Tower", timezone: "China Time" },
    payment_method: "Cash",
  ...
  },
  {
    ...
    travelers: ["Mike Clark", "Tonya Clark"],
    details: { city: "Shenzhen", room: "1 King, City View Main Tower", timezone: "China Time" },
  ...
  // === Tianjin Oct 16–18 ===
  {
    ...
    travelers: ["Tonya Clark", "Mike Clark"],
    details: { city: "Tianjin", room: "Deluxe King", guests: 2, booking_source: "Amex Travel", hilton_honors: "2039501537", timezone: "China Time" },
  ...
  // === Xi'an Oct 18–20 ===
  {
    ...
    details: { city: "Xi'an", check_in: "15:00", check_out: "12:00", timezone: "China Time" },
  ...
  // === Chongqing Oct 20–22 (David only) ===
  {
    ...
    travelers: ["David Ramos"],
    details: { city: "Chongqing", room: "Executive Suite", timezone: "China Time" },
